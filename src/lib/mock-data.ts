...
export const PRODUCTS = [
  ...
  {
    id: "conmas_gw",     nameJa: "i-Repo Gateway",
    isOption: true,
    deliveryTypes: ["onprem", "cloud"] as const,
    hasMaintenanceRate: false,
  },
  {
    id: "conmas_std",    nameJa: "i-Repo IoT standard版",
    isOption: true,
    deliveryTypes: ["subscription", "cloud"] as const,
    hasMaintenanceRate: false,
  },
  {
    id: "conmas_pro",    nameJa: "i-Repo IoT professional版",
    isOption: true,
    deliveryTypes: ["subscription", "cloud"] as const,
    hasMaintenanceRate: false,
  },
  {
    id: "conmas_map",    nameJa: "i-Repo IoT MappingTOOL",
    isOption: true,
    deliveryTypes: ["subscription", "cloud"] as const,
    hasMaintenanceRate: false,
  },
...
export const MOCK_UNIT_PRICES: UnitPrice[] = [
  ...
  { id: "up-5", productId: "conmas_std",    productName: "i-Repo IoT standard版",     deliveryType: "onprem",       tiers: [{ minLicenses: 1, price: 80000 }] },
  { id: "up-6", productId: "conmas_pro",    productName: "i-Repo IoT professional版", deliveryType: "onprem",       tiers: [{ minLicenses: 1, price: 120000 }] },
  { id: "up-7", productId: "conmas_map",    productName: "i-Repo IoT MappingTOOL",    deliveryType: "onprem",       tiers: [{ minLicenses: 1, price: 60000 }] },
