...
INSERT INTO unit_prices (id, product_id, product_name, delivery_type, tiers) VALUES
  ...
  ('up-5','conmas_std','i-Repo IoT standard版','onprem','[{"min_licenses":1,"price":80000}]'),
  ('up-6','conmas_pro','i-Repo IoT professional版','onprem','[{"min_licenses":1,"price":120000}]'),
  ('up-7','conmas_map','i-Repo IoT MappingTOOL','onprem','[{"min_licenses":1,"price":60000}]'),
